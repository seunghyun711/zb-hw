...
import com.spring.jpa.board.entity.*;
import com.spring.jpa.board.model.*;
import com.spring.jpa.board.repository.*;
...
public class BoardServiceImpl implements BoardService {
    ...
    public ServiceResult setBoardHits(Long id, String email) {
        ...
        boardHitsRepository.save(BoardHit.builder()
                .board(board)
                .user(user)
                .regDate(LocalDateTime.now())
                .build());
    ...
    public ServiceResult removeBookmark(Long id, String email) {
        ...
        if (!optionalBoardBookmark.isPresent()) {
            return ServiceResult.fail("삭제할 북마크가 존재하지 않습니다.");
        }
